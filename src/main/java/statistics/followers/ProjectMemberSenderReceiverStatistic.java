 ...
 * 
 */
public abstract class ProjectMemberSenderReceiverStatistic extends
		RelationalUniplexNetworkStatistic implements SenderReceiverStatistic {

	private static final Logger LOG = LoggerFactory
			.getLogger(ProjectMemberSenderReceiverStatistic.class.getName());

	public ProjectMemberSenderReceiverStatistic() {
