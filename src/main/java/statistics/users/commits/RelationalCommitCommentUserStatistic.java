 ...
 * 
 */
public abstract class RelationalCommitCommentUserStatistic extends
		RelationalUniplexNetworkStatistic implements UserStatistic {

	private static final Logger LOG = LoggerFactory
			.getLogger(RelationalCommitCommentUserStatistic.class.getName());

	/**
	 * 
	 */
	public RelationalCommitCommentUserStatistic() {
		senderNodeProperty = "userID";
		receiverNodeProperty = "commitID";
