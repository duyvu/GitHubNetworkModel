 ...
 * 
 */
public abstract class EgocentricCommitUserStatistic extends
		EgocentricUniplexNetworkStatistic implements UserStatistic {

	private static final Logger LOG = LoggerFactory
			.getLogger(EgocentricCommitUserStatistic.class.getName());

	/**
	 * 
	 */
	public EgocentricCommitUserStatistic() {
		nodeProperty = "authorID";
